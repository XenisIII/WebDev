<?php
/* Smarty version 4.3.0, created on 2023-03-28 21:55:02
  from 'C:\Users\pc\Desktop\Prosit\A2\WEB\livrable\WebDev\WebDev-mvc\templates\rechercheEntreprise.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_64234616bcd651_72670752',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '52f2bb21d21a7dea061756b01f3f87e6af2eeaa5' => 
    array (
      0 => 'C:\\Users\\pc\\Desktop\\Prosit\\A2\\WEB\\livrable\\WebDev\\WebDev-mvc\\templates\\rechercheEntreprise.tpl',
      1 => 1680031683,
      2 => 'file',
    ),
  ),
...
function content_64234616bcd651_72670752 (Smarty_Internal_Template $_smarty_tpl) {
            ...
            <div class=" w-[90%] sm:w-[95%] h-12 mx-[5%] divide-y mb-[2%] sm:mx-[0%] sm:my[0%] sm:mt-[2%] lg:ml-[2%]">
                <form method="get">
                    ...
                    <div class="relative">
                        ...
                        <button type="submit" formaction="/index.php/RechercheEntreprise/index?<?php echo $_smarty_tpl->tpl_vars['get']->value;?>
"
            ...
            <div
                ...
                <?php
$_smarty_tpl->tpl_vars['nbentreprise'] = new Smarty_Variable(null, $_smarty_tpl->isRenderingCache);$_smarty_tpl->tpl_vars['nbentreprise']->step = 1;$_smarty_tpl->tpl_vars['nbentreprise']->total = (int) min(ceil(($_smarty_tpl->tpl_vars['nbentreprise']->step > 0 ? $_smarty_tpl->tpl_vars['TotalEntreprise']->value-1+1 - (0+($_smarty_tpl->tpl_vars['Thispage']->value-1)*5) : 0+($_smarty_tpl->tpl_vars['Thispage']->value-1)*5-($_smarty_tpl->tpl_vars['TotalEntreprise']->value-1)+1)/abs($_smarty_tpl->tpl_vars['nbentreprise']->step)),5);
if ($_smarty_tpl->tpl_vars['nbentreprise']->total > 0) {
for ($_smarty_tpl->tpl_vars['nbentreprise']->value = 0+($_smarty_tpl->tpl_vars['Thispage']->value-1)*5, $_smarty_tpl->tpl_vars['nbentreprise']->iteration = 1;$_smarty_tpl->tpl_vars['nbentreprise']->iteration <= $_smarty_tpl->tpl_vars['nbentreprise']->total;$_smarty_tpl->tpl_vars['nbentreprise']->value += $_smarty_tpl->tpl_vars['nbentreprise']->step, $_smarty_tpl->tpl_vars['nbentreprise']->iteration++) {
$_smarty_tpl->tpl_vars['nbentreprise']->first = $_smarty_tpl->tpl_vars['nbentreprise']->iteration === 1;$_smarty_tpl->tpl_vars['nbentreprise']->last = $_smarty_tpl->tpl_vars['nbentreprise']->iteration === $_smarty_tpl->tpl_vars['nbentreprise']->total;?>
                ...
                w-[90%] sm:w-[95%] h-16 mx-[5%] mb-[2%] sm:mx-[0%] sm:my[0%] sm:mt-[2%] lg:ml-[2%]  ">
                    ...
                    <a href="/index.php/entreprise/index?id=<?php echo $_smarty_tpl->tpl_vars['AllEntreprise']->value[$_smarty_tpl->tpl_vars['nbentreprise']->value]->id_entreprise;?>
">
                        <div class="flex flex-col cursor-pointer ">
                            ...
                            <div class=''>
                                ...
                                <h2 class="mb-2 text-sm font-medium text-xl">
                                    <?php echo $_smarty_tpl->tpl_vars['AllEntreprise']->value[$_smarty_tpl->tpl_vars['nbentreprise']->value]->nom_entreprise;?>
</h2>
                                <!---->
                            </div>
                            <div class="invisible sm:visible">
                                <!-- Div pour la location ect qui se cache quand on est sur téléphone-->
                                <i class="fa fa-location-dot"></i> <?php echo $_smarty_tpl->tpl_vars['AllEntreprise']->value[$_smarty_tpl->tpl_vars['nbentreprise']->value]->localite;?>
                    ...
                    <div class="flex items-stretch self-center">
                        <i class="fa fa-star  <?php if ($_smarty_tpl->tpl_vars['AllEntreprise']->value[$_smarty_tpl->tpl_vars['nbentreprise']->value]->confiance_pilote >= 1) {?>text-yellow-300<?php } else { ?>text-black<?php }?>"
                            name="star1" id="star1"></i>
                        <i class="fa fa-star <?php if ($_smarty_tpl->tpl_vars['AllEntreprise']->value[$_smarty_tpl->tpl_vars['nbentreprise']->value]->confiance_pilote >= 2) {?>text-yellow-300<?php } else { ?>text-black<?php }?>"
                            name="star2" id="star2"></i>
                        <i class="fa fa-star <?php if ($_smarty_tpl->tpl_vars['AllEntreprise']->value[$_smarty_tpl->tpl_vars['nbentreprise']->value]->confiance_pilote >= 3) {?>text-yellow-300<?php } else { ?>text-black<?php }?>"
                            name="star3" id="star3"></i>
                        <i class="fa fa-star  <?php if ($_smarty_tpl->tpl_vars['AllEntreprise']->value[$_smarty_tpl->tpl_vars['nbentreprise']->value]->confiance_pilote >= 4) {?>text-yellow-300<?php } else { ?>text-black<?php }?>"
                            name="star4" id="star4"></i>
                        <i class="fa fa-star  <?php if ($_smarty_tpl->tpl_vars['AllEntreprise']->value[$_smarty_tpl->tpl_vars['nbentreprise']->value]->confiance_pilote >= 5) {?>text-yellow-300<?php } else { ?>text-black<?php }?>"
                    ...
                    <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                        <div>
                            <p class="text-sm text-gray-700">
                                ...
                                of
                                <span class="font-medium"><?php echo $_smarty_tpl->tpl_vars['TotalEntreprise']->value;?>
</span>
                                results
                            </p>
                        </div>
...
"><input type="radio" name="scales" value="0" <?php if ($_smarty_tpl->tpl_vars['ActualScale']->value == 0) {?>
                            checked<?php }?>></a>
                    <label for="a">Plus récent</label></br>
                    <a href="?scales=1<?php echo $_smarty_tpl->tpl_vars['SearchGet']->value;?>
"><input type="radio" name="scales" value="1" <?php if ($_smarty_tpl->tpl_vars['ActualScale']->value == 1) {?>
                            checked<?php }?>></a>
                    <label for="scales">Plus ancien</label></br>
                </form>
            </div>
