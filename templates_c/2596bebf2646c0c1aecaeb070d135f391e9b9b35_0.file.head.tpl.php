...
function content_6422b28f74fda4_39838350 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="fr">
...
>
    ...
    <?php echo '<script'; ?>
 type="text/javascript" src="/service_worker.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 type="text/javascript" src="https://code.jquery.com/jquery-1.12.4.min.js"><?php echo '</script'; ?>
>
</head>
<?php }
}
