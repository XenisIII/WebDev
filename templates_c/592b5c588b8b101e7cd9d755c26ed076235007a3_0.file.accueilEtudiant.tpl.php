...
function content_6422f857922240_34426469 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
        <div
            ...
            <div
                class="rounded-md w-[90%] sm:w-[30%] h-[8rem] bg-white mx-[5%] my-[2%] sm:mx-[0%] sm:my[0%] border border-[#dfdfdf]">
                <div
            ...
            <div
                class="rounded-md w-[90%] sm:w-[30%] h-[8rem]  bg-gray-300 mx-[5%] my-[2%] sm:mx-[0%] sm:my[0%] border border-[#dfdfdf]">
                <div
                ...
                <div
                    class="rounded-b-md h-1/2 sm:h-1/2 md:h-1/2 lg:h-[45] bg-[#fafafa] flex flex-col justify-center text-center content-center cursor-pointer">
...
?>
 ...
 <div class="px-5">
                                    <?php echo $_smarty_tpl->tpl_vars['data']->value->competence;?>
</div>
                            </li>
                            <!-- dollar est une variable/  nom_offre =attribut attribut lié a l'objet
         -->
                        <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
            ...
            <div class=" w-[90%] sm:w-[50%] h-60 bg-gray-300 mx-[5%] my-[2%] sm:mx-[0%] sm:my[0%] max-[639px]:mt-40">
                ...
                <div class="overflow-y-scroll bg-white min-[880px]:max-h-[100%] h-80 border border-[#dfdfdf]">
                    <ul class="list-disc ">
                        <li class="flex justify-between items-center px-3">Élève 1 <div
                                class="rounded-full bg-red-200 px-5 my-1"> En recherche</div>
                        </li>
                        <li class="flex justify-between items-center px-3">Élève 2 <div
                                class="rounded-full bg-red-200 px-5 my-1"> En recherche</div>
                        </li>
                        <li class="flex justify-between items-center px-3">Élève 3 <div
                                class="rounded-full bg-red-200 px-5 my-1"> En recherche</div>
                        </li>
                        <li class="flex justify-between items-center px-3">Élève 4 <div
                                class="rounded-full bg-red-200 px-5 my-1"> En recherche</div>
                        </li>
                        <li class="flex justify-between items-center px-3">Élève 5 <div
                                class="rounded-full bg-red-200 px-5 my-1"> En recherche</div>
                        </li>
                        <li class="flex justify-between items-center px-3">Élève 6 <div
                                class="rounded-full bg-red-200 px-5 my-1"> En recherche</div>
                        </li>
                        <li class="flex justify-between items-center px-3">Élève 7 <div
                                class="rounded-full bg-red-200 px-5 my-1"> En recherche</div>
                        </li>
                        <li class="flex justify-between items-center px-3">Élève 8 <div
                                class="rounded-full bg-red-200 px-5 my-1"> En recherche</div>
                        </li>
                        <li class="flex justify-between items-center px-3">Élève 9 <div
                                class="rounded-full bg-red-200 px-5 my-1"> En recherche</div>
                        </li>
                        <li class="flex justify-between items-center px-3">Élève 10 <div
                                class="rounded-full bg-red-200 px-5 my-1"> En recherche</div>
                        </li>
                        <li class="flex justify-between items-center px-3">Élève 11 <div
                                class="rounded-full bg-red-200 px-5 my-1"> En recherche</div>
                        </li>
                        <li class="flex justify-between items-center px-3">Élève 12 <div
                                class="rounded-full bg-red-200 px-5 my-1"> En recherche</div>
                        </li>
                    </ul>
                </div>
